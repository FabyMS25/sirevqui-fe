...
sessionStorage.removeItem("ticket-list");
...
function ViewTickets(data) {
    ...
    sessionStorage.setItem("ticket-list", JSON.stringify(item[0]._values));
    sessionStorage.setItem("option", "view-ticket");
    sessionStorage.setItem("ticket_no", t_id);
